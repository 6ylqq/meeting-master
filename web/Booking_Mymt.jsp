...
<%@ page import="com.design.Book.dao.MeetingRoomDao" %>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="global-navbar">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="Booking_Mymt.jsp">我的会议</a></li>
...
<main class="container" role="main">
    ...
    <div class="bookingRoom jumbotron">
        <table class="table">
            ...
            <tbody>
            <%List list=(List)request.getSession().getAttribute("Mymeeting");
            if (list!=null){
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="date" id="startDate" class="form-control" value="1979-05-04" />
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="date" id="endDate" class="form-control" value="1979-05-04" />
                        </div>
                        <div class="col-md-4">
